...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text(
                f"Level Choose: {self.current_level}",
                20,
                self.level_choosex,
                self.level_choosey,
            )
    ...
    def move_cursor(self):
        if self.game.DOWN_KEY:
            ...
            self.cursor_rect.midtop = (
                self.state_dict[self.state][0] + self.offset,
                self.state_dict[self.state][1],
            )
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            pygame.draw.rect(
                ...
                self.game.WHITE,
                pygame.Rect(
                    (self.volume_grid_size[0], self.game.DISPLAY_H / 2),
                    (self.volume_grid_size[1], 20),
                ),
            )
...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text(
                "http://dig.ccmixter.org/files/morgantj/29944",
                10,
                self.game.DISPLAY_W / 2,
